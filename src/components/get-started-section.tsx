...
import { Zap, ArrowRight, BookOpen, Network, Users, Sparkles, Hand } from "lucide-react"
    ...
    <section id="get-started" className="px-4 py-20">
      ...
      <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-4xl text-foreground md:text-5xl font-space-grotesk max-w-3xl leading-[1.2]">
            Get started now.
            </h2>
          </div>

          <div className="flex flex-col gap-1 lg:text-right text-left justify-end items-start lg:items-end lg:max-w-sm">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {items.map((item, index) => {
            ...
            return (
              <div key={index} className="justify-center items-center flex flex-col gap-4 group">
                ...
                <div className="flex flex-col gap-2 text-center">
                  ...
                  <p className="text-muted-foreground lg:max-w-sm">{item.description}</p>
                </div>
              </div>
            )
          })}
