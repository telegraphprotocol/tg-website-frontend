...
import { Network, ArrowRight, ChevronRight } from "lucide-react"
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-4xl text-foreground md:text-5xl font-space-grotesk leading-[1.2]">
              Telegraph node runners.
            </h2>
          </div>

          <div className="flex flex-col gap-1 md:max-w-md lg:text-right text-left justify-end items-start lg:items-end">
        ...
        <div className="relative my-20 flex items-center justify-center -bottom-28">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {nodeRunners.map((runner, index) => (
            <div className="flex flex-col gap-4 group z-10"
              key={index}
            >
