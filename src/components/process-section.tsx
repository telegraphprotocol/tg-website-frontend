...
export function ProcessSection() {
  const steps = [
    ...
    {
      title: "Infer",
      description: "The open-source model produces inference",
        ...
        <AnimateOnScroll direction="up" delay={0.1}>
          <div className="mb-12 text-center max-w-3xl mx-auto">
            ...
            <p className="mb-4 lg:text-lg text-base leading-relaxed text-muted-foreground">
              Connect to a Port, then place simple, standard requests (what you
              need, where, how often, and your max spend) to pull in the right
              signals—each delivered with clear receipts like source, time,
              confidence, and cost—while your Port budget handles payment and
              settlement automatically so it scales smoothly as you grow.
            </p>
          </div>
        </AnimateOnScroll>
                    ...
                    <div
                      className={cn(
                        ...
                        index !== steps.length - 1 &&
                          "lg:border-b lg:border-border/50 lg:pb-8",
                      )}
                    >
